...
export default function BaixaForm() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        title: "Sucesso",
        description: "Baixa registada com sucesso!",
      });
        ...
        <Card className="bg-glass border-glass">
          <CardHeader>
            <CardTitle className="flex items-center text-white">
              <Plus className="w-6 h-6 mr-2 text-red-400 rotate-45" />
              Baixa
            </CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex gap-4 pt-6">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-gradient-to-r from-red-500 to-rose-500 hover:shadow-glow"
                  >
